...
def final(img, left_lane, right_lane, H_inv,left_curve,right_curve,a):
    ...
    y  = np.linspace(0, img.shape[0]-1, 100)
...
video = cv2.VideoWriter('video.mp4',-1,fps-100,(width,height))
...
#    img=cv2.imread('100.jpg') 
    ...
    mask = cv2.inRange(median,np.array([0,0,190]),np.array([200,255,255]))
